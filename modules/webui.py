...
def reload_javascript():
    ...
    meta = """
        <meta name="apple-mobile-web-app-title" content="风后 Chat">
        <meta name="apple-mobile-web-app-capable" content="yes">
        <meta name="application-name" content="风后 Chat">
        <meta name='viewport' content='width=device-width, initial-scale=1.0, user-scalable=no, viewport-fit=cover'>
        <meta name="theme-color" content="#ffffff">

        <link rel="apple-touch-icon-precomposed" href="/file=web_assets/icon/robot-br.png" crossorigin="use-credentials">
        <link rel="apple-touch-icon" href="/file=web_assets/icon/robot-br.png" crossorigin="use-credentials">
