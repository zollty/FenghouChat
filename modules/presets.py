...
CHUANHU_DESCRIPTION = "FenghouChat base on [川虎](https://github.com/zollty/FenghouChat)" #i18n("由Bilibili [土风后虎虎](https://space.bilibili.com/29125536)、[明昭MZhao](https://space.bilibili.com/24807452) 和 [Keldos](https://github.com/Keldos-Li) 开发<br />访问风后Chat的 [GitHub项目](https://github.com/GaiZhenbiao/ChuanhuChatGPT) 下载最新版脚本")
